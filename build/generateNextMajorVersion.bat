...
set applicationName=RzR.Web.Middleware.ResponseTime
...
set packResultPath=$('..\nuget\')
set packProjectsPath=$('..\src\XResponseTimeMW\XResponseTimeMW.csproj')
set testProjectsPath=$('..\src\tests\XResponseTimeMW.Tests\XResponseTimeMW.Tests.csproj')
